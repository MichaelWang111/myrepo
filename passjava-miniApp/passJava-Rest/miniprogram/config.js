...
const config = {
  ...
  pages: {
    ...
    'exam': '/pages/exam/exam', //试卷详情
  },
  service: {
    getJavaQuestionAnswerById: `${baseUrl}/question/app/v1/question/info`,
    getJavaQuestionList: `${baseUrl}/question/app/v1/question/list`,
    getExamList: `${baseUrl}/question/app/v1/exam/list?page=1&limit=10&size=10&key=`,
    getExamQuestion: `${baseUrl}/question/app/v1/question/all`, //根据试卷 id 查询试卷下的所有题目
  },
  url: {

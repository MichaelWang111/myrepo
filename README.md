...
> 注意：当你加入悟空的知识星球后，星球内的所有课程都是免费学的，不仅仅是 PassJava-VIP 项目
《Spring Cloud 微服务原理剖析》已更新 16 篇，比较硬核，需要一定的基础。已同步到知识星球，后期会更新到语雀，持续更新。
《分布式协议原理》已更新 9 篇到 passjava.cn，比较硬核。还未同步到知识星球和语雀。
Java、Redis、MySQL、Elasticsearch、Docker 系列课程也在持续更新中。

### 申请代码和文档权限
如何开通 PassJava-VIP 版的权限：加入知识星球后，找我开通代码权限和文档权限，微信 passjava。

VIP 版申请代码仓库权限：https://gitcode.net/invite_link?invite_code=nNyxm67ZFuJkbpsirKxA

VIP 版私密代码仓库地址：https://gitcode.net/jackson0714/passjava

VIP 版私密文档地址：https://www.yuque.com/wukong-9bwbm/dmgis6

普通版 代码仓库地址：https://github.com/Jackson0714/PassJava-Platform

普通版公开文档：www.passjava.cn
